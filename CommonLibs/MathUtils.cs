...
namespace CommonLibs
{
    ...
    public static class MathUtils
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static DateTime ReadDateTime(long time)
        {
            return ToTimeFromUnixEpoch(TimeSpan.FromSeconds(time)).ToLocalTime();
        }
        /// <summary>
        /// 从1970年到某时间的毫秒数
        /// </summary>
        ...
        {
            defValue = defValue == null ? string.Empty : defValue;
            return value == null || string.IsNullOrEmpty(value.ToString()) ? defValue : value.ToString();
        }
